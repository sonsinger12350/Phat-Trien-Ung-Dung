    ...
    <form id="form1" name="form1" method="post">
		<div class="row">
			<div class="col-lg-12" align="center">
				<h3>Diễn Đàn Trao Đổi Giữa HS và GV</h3>
     ...
     <div class="row">
        <form id="form1" name="form1" method="post">
                    <table width="1150" border="0" align="center" cellpadding="0" cellspacing="0" class="styled-table">
                      <tbody>
                        <tr>
                          <td width="353"><h2><?php $g->laybaiviet("select tenbaiviet from baiviet where id_baiviet='$id'") ?></h2></td>
                          
                        </tr>                        	
                      </tbody>
                    </table>
                    <p><?php $g->laybaiviet("select noidung from baiviet where id_baiviet='$id'"); ?></p>
                    <p>Tệp đính kèm : <?php $g->laybaiviet("select file from baiviet where id_baiviet='$id'"); ?></p>
                    <?php
