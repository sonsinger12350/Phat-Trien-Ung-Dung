            ...
            <div class="container">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
						...
						<li>
							<a href="?action=diem" >Kết Quả Học Tập</a>
						</li>
						<li>
							<a href="../chat/index.php" >Trò Chuyện</a>
						</li>
						<li>
							<a href="?action=hoso" >Thông tin cá nhân</a>
						</li>
                         <li class="dropdown">
							<a href="#" class="dropdown-toggle " data-toggle="dropdown" data-hover="dropdown" data-delay="0" data-close-others="false"><img src="../../images/<?php $hs->anh("select anh from hososinhvien where masv = '$malogin'");?>" width="30px" height="30px"> <i class="fa fa-angle-down"></i> <?php echo ''.$_SESSION['ten'];?></a>
		...
		<div class="row" style="height : 400px;">
			<div class="col-lg-12">
                ...
                <?php 
					...
					elseif($ac=='hoso')
					{include("hoso.php");}
					elseif($ac=='updatehoso')
					{include("updatehoso.php");}
					elseif($ac=='doimatkhau')
					{include("doimk.php");}	
					elseif($ac=='doimatkhau')
					{include("doimk.php");}	
					elseif($ac=='diendan')
